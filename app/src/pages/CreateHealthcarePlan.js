...
export default function CreateHealthcarePlan() {
        ...
        <>
            ...
            {!location.state ? <></> :
                <>
                    ...
                    <div id="wrapper">
                        <div className='main-container'>
                            ...
                            <div id="plan-actions">
                                ...
                                <Button onClick={createHealthcarePlan} variant='success' >Create Plan</Button>
                    ...
                    <Modal style={{ color: "#293241", }} show={showModal} onHide={handleClose}>
